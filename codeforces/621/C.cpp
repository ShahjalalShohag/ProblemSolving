...
int main()
{
    ...
    ld ans=0;
    for(i=1;i<=n;i++){
        l1=v[i-1].F,r1=v[i-1].S,l2=v[i].F,r2=v[i].S;
        a1=r1/p-(l1-1)/p;
        a2=r2/p-(l2-1)/p;
        ans+=(1.0*a1/(1.0*(r1-l1+1))+1.0*a2/(1.0*(r2-l2+1))-(1.0*a1*a2)/(1.0*(r1-l1+1)*(r2-l2+1)));
    }
    cout<<fixed<<setprecision(10)<<2000.0*ans<<nl;
    return 0;
}
