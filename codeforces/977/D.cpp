...
bool cmp(ll x,ll y)
{
    ll cnt12=0,cnt13=0,cnt22=0,cnt23=0;
    while(x%3==0) x/=3,cnt13++;
    while(x%2==0) x/=2,cnt12++;
    while(y%3==0) y/=3,cnt23++;
    while(y%2==0) y/=2,cnt22++;
    if(cnt13==cnt23) return cnt12<cnt22;
    else return cnt13>cnt23;
}
int main()
{
    fast;
