...
int main()
{
    ...
    ll i,j,k,n,m,a,b,sz;
    cin>>n>>a>>b;
    for(i=0;i<n;i++) cin>>k,v.pb({k,i+1});
    srt(v);
    ll st2,st1,ok=0;
    ...
    if(ok){
        cout<<"Yes\n";
        cout<<st2-st1<<' '<<n-st2<<nl;
        for(i=0;i<st2-st1;i++) cout<<v[st1+i].S<<' ';
        cout<<nl;
        for(i=0;i<n-st2;i++) cout<<v[st2+i].S<<' ';
        cout<<nl;
        return 0;
    }
    ok=0;
    ...
    if(ok){
        cout<<"Yes\n";
        cout<<n-st1<<' '<<st1-st2<<nl;
        for(i=0;i<n-st1;i++) cout<<v[st1+i].S<<' ';
        cout<<nl;
        for(i=0;i<st1-st2;i++) cout<<v[st2+i].S<<' ';
        cout<<nl;
        return 0;
    }
    cout<<"No\n";
